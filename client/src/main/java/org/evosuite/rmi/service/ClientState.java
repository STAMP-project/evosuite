...
public enum ClientState {
	...
	CARVING_MODEL("Carving", "Carving behavioral models", 4),
	SEARCH("Search", "Generating test cases", 5),
	INLINING("Inlining", "Inlining constants", 6),
	MINIMIZING_VALUES("Minimizing values", "Minimizing primitive values in the tests", 7),
	MINIMIZATION("Minimizing", "Minimizing size/length of test cases", 8),
	//TODO, question: why is it before ASSERTION?
	COVERAGE_ANALYSIS("Coverage Analysis","Compute and the different coverage criteria of the generated test suite",9),
	ASSERTION_GENERATION("Generating assertions", "Adding assertions to the test cases", 10),
