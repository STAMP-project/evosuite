...
/**
 * Secondary objective that prefers test suites that execute a path in the CUT that has a smaller
...
public class MinimizePathExecutionCountSecondaryObjective extends
  ...
  private static final Logger logger = LoggerFactory
      .getLogger(
          MinimizePathExecutionCountSecondaryObjective.class);
  ...
  /**
   * Compares two test suite chromosomes, preferring the one that covers the least path weight.
   */
  @Override
   ...
   * test suite that has the smallest weight.
   */
  @Override
